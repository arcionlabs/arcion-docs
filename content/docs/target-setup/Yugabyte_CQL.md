...
1. From `$REPLICANT_HOME`, navigate to the sample YugabyteCQL connection configuration file:
    ```BASH
...
1. From `$REPLICANT_HOME`, navigate to the sample YugabyteCQL applier configuration file:
    ```BASH
